...
var normalizeCjs = require('boot/pipeline/normalizeCjs');
var createNormalizer = require('boot/lib/createNormalizer');
var createVersionedIdTransform = require('boot/lib/createVersionedIdTransform');
var locatePackage = require('boot/pipeline/locatePackage');
var fetchAsText = require('boot/pipeline/fetchAsText');
var translateAsIs = require('boot/pipeline/translateAsIs');
var instantiateNode = require('boot/pipeline/instantiateNode');
var instantiateAmd = require('boot/pipeline/instantiateAmd');
